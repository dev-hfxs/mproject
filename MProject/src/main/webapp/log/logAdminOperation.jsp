	...
	<table id="dg" class="easyui-datagrid"  
		...
		<thead>
			<tr>
				...
				<th data-options="field:'operation_module',width:150,sortable:true">操作模块</th>
				<th data-options="field:'operation_desc',width:300">操作描述</th>
				<th data-options="field:'operation_date',width:180,sortable:true">操作时间</th>
			</tr>
		</thead>
	</table>
</div>
...
$(function() {
	...
	queryParams.sqlId = 'mproject-log-getAdminLog';
