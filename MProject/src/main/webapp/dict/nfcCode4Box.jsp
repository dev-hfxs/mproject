...
$(function() {
	...
	queryParams.sqlId = 'mproject-dict-queryBoxNfcsAll';
...
function importCode(){
	var content = '<iframe src="<%=path%>/dict/codeImport.jsp?codeName=box" width="100%" height="80%" frameborder="0" scrolling="no"></iframe>';
	var boarddiv = '<div id="msgwindow" title="导入机箱NFC序列号" ></div>'// style="overflow:hidden;"可以去掉滚动条
