...
$(function() {
	...
	queryParams.sqlId = 'mproject-dict-queryMoxaNfcsAll';
...
function importCode(){
	var content = '<iframe src="<%=path%>/dict/codeImport.jsp?codeName=moxa" width="100%" height="80%" frameborder="0" scrolling="no"></iframe>';
	var boarddiv = '<div id="msgwindow" title="导入MOXA-NFC序列号" ></div>'// style="overflow:hidden;"可以去掉滚动条
