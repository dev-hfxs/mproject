...
public class CacheConfig implements java.io.Serializable {
	...
	/**
	 * @param distributedCacheSupported
	 *            the distributedCacheSupported to set
	 */
	...
	/**
	 * @param dayFiexInvalidTime
	 *            the dayFiexInvalidTime to set
	 */
	...
	/**
	 * @param isShareCrossWebApp
	 *            the isShareCrossWebApp to set
	 */
