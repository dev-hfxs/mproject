package com.sierotech.mproject.cache;
...
public class EhCacheProvider implements CacheProvider {
	...
	private Map<String, com.sierotech.mproject.cache.ObjCache> cachePoolMap = new HashMap<String, com.sierotech.mproject.cache.ObjCache>();
	...
	public <K, V> ObjCache buildCache(String cacheName, Class<K> keyType, Class<V> valueType, CacheConfig config)
			throws CacheException {
		Cache<K, V> newCache = this.cacheManager.createCache(cacheName, CacheConfigurationBuilder
				.newCacheConfigurationBuilder(keyType, valueType, ResourcePoolsBuilder.heap(1024 * 1024)).build());
		if (newCache == null) {
